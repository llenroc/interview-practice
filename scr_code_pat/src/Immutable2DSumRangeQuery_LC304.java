 ...
 */
public class Immutable2DSumRangeQuery_LC304 {
    private int[][] T;

    public Immutable2DSumRangeQuery_LC304(int[][] matrix) {
        int row = 0;
        int col = 0;
        if (matrix.length != 0) {
            row = matrix.length;
    ...
    public static void main(String args[]) {
        ...
        Immutable2DSumRangeQuery_LC304 isr = new Immutable2DSumRangeQuery_LC304(input1);
